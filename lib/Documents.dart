...
class Documents extends StatefulWidget {
  Documents({Key? key, required ValueChanged<bool> onThemeChanged}) : super(key: key);
...
// Initialize the "Recycle Bin" directory
  ...
  Future<void> getDownloadsDirectory() async {
    _downloadsDirectory = Directory('/storage/emulated/0/Download/Documents');
  ...
  Future<void> addFile() async {
    FilePickerResult? result = await FilePicker.platform.pickFiles(
      ...
      allowedExtensions: ['doc', 'docx', 'pdf', 'txt', 'xlsx', 'xls', 'ppt', 'pptx'],
    );
